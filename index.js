...
let scene = null;
let renderer = null;
let mesh = null; // eslint-disable-line
const worldWidth = 2;
const worldDepth = 2;
...
function init() {
    ...
    const bottomGeometry = new THREE.PlaneBufferGeometry(100, 100);

    bottomGeometry.attributes.uv.array[5] = 0.5;
    bottomGeometry.attributes.uv.array[7] = 0.5;
    bottomGeometry.rotateX(Math.PI / 2);
    bottomGeometry.translate(0, -50, 0);
    //
    ...
    const bottomTmpGeometry = new THREE.Geometry().fromBufferGeometry(bottomGeometry);
    ...
    for (let z = 0; z < worldDepth; z++) {
        for (let x = 0; x < worldWidth; x++) {
            ...
            // if ((nz !== h && nz !== h + 1) || z === 0) {
                ...
                tmpGeometry.merge(bottomTmpGeometry, matrix);
            // }
        }
    }
