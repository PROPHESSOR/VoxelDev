...
!(function(e) {
    ...
    } let s=t.prototype, o=e.EventEmitter; 

    s.getListeners=function(e) {
        let t, n, r=this._getEvents(); 

        if (e instanceof RegExp) {
            t={}; for (n in r)r.hasOwnProperty(n)&&e.test(n)&&(t[n]=r[n])
        } else t=r[e]||(r[e]=[]); 
        ...
        let t, n=this.getListeners(e); 

        return n instanceof Array&&(t={}, t[e]=n), t||n 
    }, s.addListener=function(e, t) {
        if (!i(t)) throw new TypeError("listener must be a function"); let r, s=this.getListenersAsObject(e), o="object"===typeof t; 

        for (r in s)s.hasOwnProperty(r)&&n(s[r], t)===-1&&s[r].push(o?t:{ "listener": t, "once": !1 }); 
        ...
        let r, i, s=this.getListenersAsObject(e); 

        for (i in s)s.hasOwnProperty(i)&&(r=n(s[i], t), r!==-1&&s[i].splice(r, 1)); 
        ...
        let r, i, s=e?this.removeListener:this.addListener, o=e?this.removeListeners:this.addListeners; 
        ...
        let t, n=typeof e, r=this._getEvents(); 
        ...
        let n, r, i, s, o, u=this.getListenersAsObject(e); 

        for (s in u) if (u.hasOwnProperty(s)) for (n=u[s].slice(0), i=0; i<n.length; i++)r=n[i], r.once===!0&&this.removeListener(e, r.listener), o=r.listener.apply(this, t||[]), o===this._getOnceReturnValue()&&this.removeListener(e, r.listener); 
    ...
    }, "function"===typeof define&&define.amd?define(() => t):"object"===typeof module&&module.exports?module.exports=t:e.EventEmitter=t 
}(this||{}));
